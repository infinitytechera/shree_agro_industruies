...
namespace shree_agro
{
    public partial class Sale : Form
    {
        ...
        private void search()
        {
            ...
            {
                dt_inv = sp_sqlconnection.get_sp("pur_sale_detail", "qtype=search_inv_type|c_id=" + UserDetail.c_id + "|inv_type=SALE|inv_no=" + txt_ser_inv_no.Text + "");
            }
            else if (txt_ser_voucher.Text != "")
            {
                dt_inv = sp_sqlconnection.get_sp("pur_sale_detail", "qtype=search_voucher_type|c_id=" + UserDetail.c_id + "|inv_type=SALE|voucher=" + txt_ser_voucher.Text + "");
            }
